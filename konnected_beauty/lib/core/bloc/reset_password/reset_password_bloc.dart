...
class VerifyResetPasswordOtp extends ResetPasswordEvent {
  final String email;
  final String otp;
  VerifyResetPasswordOtp({required this.email, required this.otp});
}
...
class ResetPasswordBloc extends Bloc<ResetPasswordEvent, ResetPasswordState> {
  ...
  Future<void> _onRequestPasswordReset(
    ...
    try {
      final result = await SalonAuthService.requestPasswordReset(
        email: event.email,
      );
  ...
  Future<void> _onVerifyResetPasswordOtp(
    ...
    try {
      final result = await SalonAuthService.verifyResetPasswordOtp(
        email: event.email,
        otp: event.otp,
      );
  ...
  Future<void> _onResetPassword(
    ...
    try {
      final result = await SalonAuthService.resetPassword(
