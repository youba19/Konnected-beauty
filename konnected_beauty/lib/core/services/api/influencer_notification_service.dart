...
class InfluencerNotificationService {
  ...
  /// Fetch influencer notifications
  static Future<Map<String, dynamic>> getNotifications({
    int page = 1,
    int limit = 10,
  }) async {
    try {
      print('🔔 === FETCHING INFLUENCER NOTIFICATIONS ===');
      print('📋 Page: $page');
      print('📋 Limit: $limit');
      ...
      final response = await HttpInterceptor.authenticatedRequest(
        method: 'GET',
        endpoint: '/influencer-notification',
        headers: {
  ...
  static Future<Map<String, dynamic>> markNotificationAsViewed({
    ...
    try {
      ...
      final response = await HttpInterceptor.authenticatedRequest(
        method: 'PATCH',
        endpoint: '/influencer-notification/$notificationId/mark-as-vued',
        headers: {
          'Content-Type': 'application/json',
          'Accept': 'application/json',
        },
