...
void main() {
  group('Forgot Password Flow Tests', () {
    testWidgets('should show forgot password screen with role selection', (WidgetTester tester) async {
    ...
    testWidgets('should show OTP verification screen', (WidgetTester tester) async {
