...
void main() {
  group('OTP Validation Tests', () {
    ...
    test('validateOtp endpoint is correctly defined', () {
      ...
      expect(SalonAuthService.validateOtpEndpoint, equals('/salon-auth/validate-otp'));
      expect(SalonAuthService.baseUrl, equals('http://srv950342.hstgr.cloud:3000'));
    });
    ...
    test('formatMessage method handles different message types', () {
      // Test string message
      expect(SalonAuthService.formatMessage('Test message'), equals('Test message'));
      
      // Test list message
      expect(SalonAuthService.formatMessage(['Error 1', 'Error 2']), equals('Error 1, Error 2'));
